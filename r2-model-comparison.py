...
veriler2 = veriler.iloc[:,2:6]
print(veriler2.corr())
print("\n \n")
#değişkenlerin birbiriyle olan bağlantısını gösterir
...
print('Polynomial R2 degeri : ',r2_score(Y, lin_reg2.predict(poly_reg.fit_transform(X))))
